                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-y-4 flex-col">
                            ...
                            <a href="https://www.reddit.com/r/VintageStory/comments/1nngt2b/introducing_story_forge_a_fast_modern_vintage/" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
