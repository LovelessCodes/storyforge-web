      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href="https://discord.gg/gByx63peUC" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="sm">
                <svg role="img" className="w-4 h-4 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <title>Discord</title>
